...
acf_add_local_field_group(array(
    'key' => 'group_otro_repuesto',
    'title' => 'Detalles del Repuesto',
    'fields' => array(
        array(
            'key' => 'field_repuesto_marca',
            'label' => 'Marca',
            'name' => 'marca',
            'type' => 'taxonomy',
            'taxonomy' => 'marca',
        ...
        array(
            'key' => 'field_repuesto_tipo_o_referencia',
            'label' => 'Tipo o referencia',
            'name' => 'tipo_o_referencia',
            'type' => 'text',
        ),
        array(
            'key' => 'field_repuesto_image',
            'label' => 'Imagen del Repuesto',
            'name' => 'motor_image',
            'type' => 'image',
            'instructions' => 'Añada la imagen principal del repuesto.',
            'return_format' => 'array',
            'preview_size' => 'thumbnail',
            'library' => 'all',
        ),
        array(
            'key' => 'field_repuesto_gallery',
            'label' => 'Galería de Imágenes',
            'name' => 'motor_gallery',
            'type' => 'gallery',
            'instructions' => 'Añada hasta 5 imágenes del repuesto.',
            'max' => 5,
            'insert' => 'append',
            'library' => 'all',
        ),
        array(
            'key' => 'field_repuesto_pais',
            'label' => 'País (localización)',
            'name' => 'pais',
            'type' => 'select',
            'choices' => array(
        ...
        array(
            'key' => 'field_repuesto_provincia',
            'label' => 'Provincia',
            'name' => 'provincia',
            'type' => 'text',
        ),
        array(
            'key' => 'field_repuesto_estado_del_articulo',
            'label' => 'Estado del artículo',
            'name' => 'estado_del_articulo',
            'type' => 'select',
            'choices' => array(
        ...
        array(
            'key' => 'field_repuesto_descripcion',
            'label' => 'Descripción',
            'name' => 'descripcion',
            'type' => 'textarea',
        ),
        array(
            'key' => 'field_repuesto_precio_de_venta',
            'label' => 'Precio de venta',
            'name' => 'precio_de_venta',
            'type' => 'number',
            'prepend' => '€',
        ...
        array(
            'key' => 'field_repuesto_precio_negociable',
            'label' => 'Precio negociable',
            'name' => 'precio_negociable',
            'type' => 'radio',
            'choices' => array(
        ...
        array(
            'key' => 'field_repuesto_documentacion_adicional',
            'label' => 'Documentación Adicional',
            'name' => 'documentacion_adicional',
            'type' => 'repeater',
            'instructions' => 'Añada hasta 5 documentos adicionales.',
            ...
            'sub_fields' => array(
                array(
                    'key' => 'field_repuesto_documento_archivo',
                    'label' => 'Archivo',
                    'name' => 'archivo',
                    'type' => 'file',
                    'return_format' => 'array',
                ...
                array(
                    'key' => 'field_repuesto_documento_nombre',
                    'label' => 'Nombre del Documento',
                    'name' => 'nombre',
                    'type' => 'text',
                ),
