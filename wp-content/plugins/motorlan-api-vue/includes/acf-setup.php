...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			...
			'name' => 'motor_image',
			'type' => 'image',
			'instructions' => 'Añada la imagen principal de la publicación.',
			'return_format' => 'array',
		...
		array(
			...
			'name' => 'motor_gallery',
			'type' => 'gallery',
			'instructions' => 'Añada hasta 5 imágenes de la publicación. La "Imagen Destacada" principal de WordPress se gestiona por separado.',
			'max' => 5,
			'insert' => 'append',
