...
// 👉 Fetching users
const { data: usersData, execute: fetchUsers } = await useApi<any>(createUrl('/dashboard/users', {
  query: {
    q: searchQuery,
        ...
        <template #item.user="{ item }">
          <div class="d-flex align-center gap-x-4">
            ...
            <div class="d-flex flex-column">
              <h6 class="text-base">
                <RouterLink
                  :to="{ name: 'dashboard-user-view-id', params: { id: item.id } }"
        ...
        <template #item.actions="{ item }">
          ...
          >
            ...
            <VMenu activator="parent">
              <VList>
                <VListItem :to="{ name: 'dashboard-user-view-id', params: { id: item.id } }">
                  <template #prepend>
                    <VIcon icon="tabler-eye" />
                  </template>
