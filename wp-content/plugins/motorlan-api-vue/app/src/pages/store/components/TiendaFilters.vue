...
<template>
  <aside class="filters pa-4">
    ...
    <AppSelect v-model="selectedState" label="Estado" placeholder="Seleccionar estado" item-title="name" item-value="value"  :items="[{'name':'Nuevo', 'value':'new'},{'name':'Usado', 'value':'used'},{'name':'Restaurado', 'value':'restored'}]" class="mb-4" variant="outlined" color="error" clearable />
  </aside>
</template>
