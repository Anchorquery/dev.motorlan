...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-publicaciones-publicacion-add': RouteRecordInfo<'apps-publicaciones-publicacion-add', '/apps/publicaciones/publicacion/add', Record<never, never>, Record<never, never>>,
    'apps-publicaciones-publicacion-edit-uuid': RouteRecordInfo<'apps-publicaciones-publicacion-edit-uuid', '/apps/publicaciones/publicacion/edit/:uuid', { uuid: ParamValue<true> }, { uuid: ParamValue<false> }>,
    'apps-publicaciones-publicacion-list': RouteRecordInfo<'apps-publicaciones-publicacion-list', '/apps/publicaciones/publicacion/list', Record<never, never>, Record<never, never>>,
    'apps-my-account-parent': RouteRecordInfo<'apps-my-account-parent', '/apps/my-account', Record<never, never>, Record<never, never>>,
    'apps-my-account': RouteRecordInfo<'apps-my-account', '/apps/my-account', Record<never, never>, Record<never, never>>,
    'apps-my-account-favorites': RouteRecordInfo<'apps-my-account-favorites', '/apps/my-account/favorites', Record<never, never>, Record<never, never>>,
    'apps-my-account-opinions': RouteRecordInfo<'apps-my-account-opinions', '/apps/my-account/opinions', Record<never, never>, Record<never, never>>,
    'apps-my-account-purchases': RouteRecordInfo<'apps-my-account-purchases', '/apps/my-account/purchases', Record<never, never>, Record<never, never>>,
    'apps-my-account-questions': RouteRecordInfo<'apps-my-account-questions', '/apps/my-account/questions', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-publicaciones': RouteRecordInfo<'dashboards-publicaciones', '/dashboards/publicaciones', Record<never, never>, Record<never, never>>,
    ...
    'tienda-components-publicacion-info': RouteRecordInfo<'tienda-components-publicacion-info', '/tienda/components/PublicacionInfo', Record<never, never>, Record<never, never>>,
    'tienda-components-publicacion-items': RouteRecordInfo<'tienda-components-publicacion-items', '/tienda/components/PublicacionItems', Record<never, never>, Record<never, never>>,
    'tienda-components-publicacion-questions': RouteRecordInfo<'tienda-components-publicacion-questions', '/tienda/components/PublicacionQuestions', Record<never, never>, Record<never, never>>,
    'tienda-components-pagination-controls': RouteRecordInfo<'tienda-components-pagination-controls', '/tienda/components/PaginationControls', Record<never, never>, Record<never, never>>,
    ...
    'tienda-components-search-bar': RouteRecordInfo<'tienda-components-search-bar', '/tienda/components/SearchBar', Record<never, never>, Record<never, never>>,
    'tienda-components-tienda-filters': RouteRecordInfo<'tienda-components-tienda-filters', '/tienda/components/TiendaFilters', Record<never, never>, Record<never, never>>,
