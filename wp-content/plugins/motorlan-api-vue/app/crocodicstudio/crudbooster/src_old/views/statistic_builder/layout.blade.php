...
<head>
    ...
    <link rel="shortcut icon"
          href="{{ CRUDBooster::getSetting('favicon')?asset(CRUDBooster::getSetting('favicon')):asset('public/vendor/crudbooster/assets/logo_crudbooster.png') }}">
    ...
    <!-- Font Awesome Icons -->
    <link href="{{asset("public/vendor/crudbooster/assets/adminlte/font-awesome/css")}}/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <!-- Ionicons -->
    ...
    <!-- Theme style -->
    <link href="{{ asset("public/vendor/crudbooster/assets/adminlte/dist/css/AdminLTE.min.css")}}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset("public/vendor/crudbooster/assets/adminlte/dist/css/skins/_all-skins.min.css")}}" rel="stylesheet" type="text/css"/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-smallbox' class='button-widget-area'>
                    <a href="#" data-component='smallbox' class='btn-add-widget add-small-box'>
                        <img src='{{asset("public/vendor/crudbooster/assets/statistic_builder/smallbox.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-table' class='button-widget-area'>
                    <a href="#" data-component='table' class='btn-add-widget add-table'>
                        <img src='{{asset("public/vendor/crudbooster/assets/statistic_builder/table.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-chartarea' class='button-widget-area'>
                    <a href="#" data-component='chartarea' class='btn-add-widget add-chart-area'>
                        <img src='{{asset("public/vendor/crudbooster/assets/statistic_builder/chart_area.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-panelarea' class='button-widget-area'>
                    <a href="#" data-component='panelarea' class='btn-add-widget add-panel-area'>
                        <img src='{{asset("public/vendor/crudbooster/assets/statistic_builder/panel.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-chartarea' class='button-widget-area'>
                    <a href="#" data-component='chartline' class='btn-add-widget add-chart-line'>
                        <img src='{{asset("public/vendor/crudbooster/assets/statistic_builder/chart_line.png")}}'/>
            ...
            <li class='connectedSortable' title='Drag To Main Area'>
                <div id='btn-chartarea' class='button-widget-area'>
                    <a href="#" data-component='chartbar' class='btn-add-widget add-chart-bar'>
                        <img src='{{asset("public/vendor/crudbooster/assets/statistic_builder/chart_bar.png")}}'/>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
      ...
      user experience -->
<!-- SlimScroll 1.3.0 -->
<script src="{{ asset('public/vendor/crudbooster/assets/adminlte/plugins/slimScroll/jquery.slimscroll.min.js')}}"></script>
