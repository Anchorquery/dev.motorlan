...
<head>
    ...
    <!-- Ionicons -->
    <link href="{{asset("public/vendor/crudbooster/ionic/css/ionicons.min.css")}}" rel="stylesheet" type="text/css"/>
    <!-- Theme style -->
    ...
    <link rel='stylesheet' href='{{asset("public/vendor/crudbooster/assets/css/main.css").'?r='.time()}}'/>
